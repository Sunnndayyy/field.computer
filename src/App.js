...
const HeadingWithSpacing = ({ children }) => (
  <>
    <h2 className="w-full px-6 py-4 mx-6 text-lg sm:w-full sm:px-4 sm:mx-2 lg:w-1/2 lg:px-0 lg:mx-0 2xl:w-[708px] text-2xl">{children}</h2>
...
function HomePage() {
  ...
  return (
    <div className="grid justify-items-center content-start">
      <div className="h-24 sm:h-60"></div>
      <HeadingWithSpacing>
      ...
      <div className="w-full px-6 py-4 mx-6 text-lg sm:w-full sm:px-4 sm:mx-2 lg:w-1/2 lg:px-0 lg:mx-0 2xl:w-[708px]">
        <button
          id="moreBtn"
          onClick={() => setShowMore(!showMore)}
          className="font-bold text-lg sm:text-2xl inline-block"
        >
...
export default function App() {
  return (
    <>
      <header className="fixed top-0 left-0 px-6 py-4 text-xs font-bold sm:p-4 sm:text-sm">
        field
      </header>
      <Routes>
